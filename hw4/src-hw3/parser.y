...
FunctionDefinition:
    ...
    CompoundStatement
    END {
        FunctionNode* funct = new FunctionNode(@1.first_line, @1.first_column, $3, $5, $1, $6);
        $$ = funct;
    }
;
...
FormalArg:
    IdList COLON Type {
        DeclNode* decl = new DeclNode(@1.first_line, @1.first_column, $3, $1);
        $$ = decl;
    }
;
...
StringAndBoolean:
    STRING_LITERAL {
        char* new_str = (char*)calloc(strlen($1)-1, sizeof(char));
        strncpy(new_str, $1+1, strlen($1)-2);
        const char* ret_str = new_str;
...
For:
    ...
    END DO {
        ...
        DeclNode* decl = new DeclNode(@2.first_line, @2.first_column, "integer", var);
